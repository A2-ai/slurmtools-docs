...
If your template file needs additional arguments `slurm_template_opts` is how to inject them. This argument is a named list of argument, value pairs. If you need to supply an email address for notifications you can set this argument to `list('email' = 'matthews@a2-ai.com')`