...
This guide assumes you are familiar with cancelling NONMEM jobs using the [default arguments](/slurmtools-docs/guides/cancel_slurm_job), and are looking for more control over you job submission. We'll cover each argument to `cancel_slurm_job` and overriding the default.
...
import cancel_other_confirm from '/src/code/cancel_job_confirm.R?raw'
