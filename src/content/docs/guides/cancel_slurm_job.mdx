...
import cancel_job from '/src/cancel_job.R?raw';
...
See the [`cancel_slurm_job` reference guide](/reference/cancel_slurm_job_reference) for more detailed explaination of the function.