...
<Steps>
1. [submit_slurm_job](/guides/submit_slurm_job) - Easily submit jobs with this `sbatch` wrapper
2. [get_slurm_jobs](/guides/get_slurm_partitions) - Get a summary of running jobs with this `squeue` wrapper
3. [cancel_slurm_job](/guides/cancel_slurm_job) - Cancel a job with this `scancel` wrapper
