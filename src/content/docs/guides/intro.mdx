...
<Steps>
1. [submit_slurm_job](/slurmtools-docs/guides/submit_slurm_job ) - Easily submit jobs with this `sbatch` wrapper
2. [get_slurm_jobs](/slurmtools-docs/guides/get_slurm_partitions) - Get a summary of running jobs with this `squeue` wrapper
3. [cancel_slurm_job](/slurmtools-docs/guides/cancel_slurm_job) - Cancel a job with this `scancel` wrapper
4. [get_slurm_partitions](/slurmtools-docs/guides/get_slurm_partitions) - Get a list of available partitions with this `sinfo` wrapper
</Steps>
